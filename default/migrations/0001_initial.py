# Generated by Django 4.0.2 on 2022-02-27 00:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level_of_study', models.CharField(choices=[('High School/Secondary School', 'High School/Secondary School'), ('University (Undergrad)', 'University (Undergrad)'), ("University (Master's/Doctoral)", "University (Master's/Doctoral)"), ('Vocational/Code School', 'Vocational/Code School'), ('Not currently a student', 'Not currently a student'), ('TCNJ Alum', 'TCNJ Alum'), ('TCNJ Professor', 'TCNJ Professor')], default='University (Undergrad)', max_length=60)),
