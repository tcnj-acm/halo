...
urlpatterns = [
     ...
     path('download/hackers-checked-in/', views.export_checkedin_hackers_csv, name='export-checkedin-hackers'),
     path('download/waiting-list/', views.export_waiting_list, name='export-waiting-list'),
